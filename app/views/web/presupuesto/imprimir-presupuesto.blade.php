...
<body>
	<table>
		<tr>
			<td id="header" colspan="2">PRESUPUESTO</td>
		</tr>
		...
		<tr>
			...
			<td class="derecha width40 padding0">
				<table align="right" class="width300 cuadrado">
					<tr>
						<td class="gris izquierda width50 cuadrado">N° de Presupuesto</td>
			...
			<td colspan="2" class="padding0">
				<table>
					...
					@foreach($detalles as $producto)
						@if ($producto->presupuesto->id == $imprimir->id)
							<tr>
		...
		<tr id="termino">
			<td colspan="2" id="termino">
				<h5>Terminos</h5>
				<div>Valido por 7 dias desde la fecha que se realizo el presupuesto</div>
			</td>
		</tr>
	</table>
