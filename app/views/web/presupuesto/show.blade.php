	...
	<div class="col-md-12">
		<div class="box box-info">
			<div class="box-header">
				<h3 class="box-title">Detalle del Presupuesto Nro. {{$presupuestos->id}}</h3>
			</div>
			<div class="box-body no-padding">
				...
				<table class="table table-striped">
					...
					<tbody>
						...
						@if ($producto->presupuesto->id == $presupuestos->id)
							<tr>
								<td>
				...
				<div class="box-tools pull-right">
					<a href="{{ url('presupuesto') }}" class="btn btn-primary blanco">Volver a la Lista de Presupuestos</a>
				</div>
			</div>
		</div>
	</div>
