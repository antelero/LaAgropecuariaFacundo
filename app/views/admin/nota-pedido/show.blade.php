            ...
            <div class="box box-info">
                ...
                <div class="box-body no-padding">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($producto->producto->imagen)
                                        <img src="{{ asset('assets/imagen/producto/' . $producto->producto->imagen) }}"
                                             height="25%" alt="{{ $producto->producto->nombre }}">
                                    @else
                    ...
                    <div class="box-tools pull-right">
                        <a href="{{ url('admin/orden-compra') }}" class="btn btn-primary blanco">Volver a la Lista de
                            Ordenes de Compra</a>
                        <input data-confirm="¿Esta seguro de continuar la operacion?" class="btn btn-success"
                               type="submit"
                               value="Cobrar y Actualizar Stock" {{ $ordenCompra->estado == 0 ? '' : 'disabled' }}>
                    </div>
                    {{ Form::close() }}
                </div>
