                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <table class="table table-bordered table-hover factura">
                                    ...
                                    <tbody>
                                        <tr>
                                        <td>
                                            <input type="text" name="producto[1][codigo]" id="codigo_1" class="form-control" autocomplete="off">
                                        </td>
                                        <td>
                                            <div class="input-group">
                                                <input type="text" name="producto[1][concepto]" id="concepto_1" class="form-control" autocomplete="off">
                                                <div class="input-group-btn">
                                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#productoModal" data-id="1">
                                        ...
                                        <td>
                                            <input type="text" name="producto[1][cantidad]" id="cantidad_1" class="form-control cambio" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;">
                                        </td>
                                        <td>
                                            <button type="button" class="btn btn-sm btn-danger eliminar" title="Quitar concepto">
