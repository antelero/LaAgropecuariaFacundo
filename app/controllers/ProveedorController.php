...
class ProveedorController extends \BaseController
{
    ...
    public function index()
    {
        ...
        return View::make('admin.proveedor.index', compact('proveedores'));
    ...
    public function create()
    {
        ...
        return View::make('admin.proveedor.create', compact('proveedor'));
    }
    ...
    public function store()
    {
        ...
        if ($validar->passes()) {
            ...
            $proveedor->detalle          = $datos['detalle'];
            ...
            if (Input::hasFile('imagen')) {
                ...
                $rutaImagen           = public_path('assets/imagen/proveedor/' . $nombreImagen);
                ...
                if (!File::isDirectory(public_path('assets/imagen/proveedor/'))) {
                    // Si no existe lo creamos con los correspondientes permisos
                    File::makeDirectory(public_path('assets/imagen/proveedor/'), 0775, true);
                }
            ...
            return Redirect::to('admin/proveedor')->with('exito', 'El proveedor fue creado');
        } else {
